...
\end{itemize}
 ...
 Por otro lado, la lista tabú está representada por un vector de $n$ elementos donde en la $i$-ésima posición esta el ``valor tabú'' del $i$-ésimo nodo. Por lo tanto, poner como tabú a un nodo o ver su valor es equivalente a acceder\footnote{http://www.cplusplus.com/reference/vector/vector/operator[]/} a un elemento del arreglo que es constante.\newline
