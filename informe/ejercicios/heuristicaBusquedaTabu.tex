...
Mientras que la solucion optima tiene frontera: \newline
...
\subsection{Experimentación}
 ...
 El siguiente gráfico muestra, para diferentes $desviacion\_permitida$ y una densidad de aristas igual al 50$\%$ respecto a los nodos, el resultado temporal, y luego de calidad. Los grafos son aleatorios, este tipo de grafos son explicitados mas adelante en la sección $experimentacion$.
