...
CANT_NODOS_MAX=100000 # Cantidad maxima de nodos por cada grafo
...
g++ -std=c++0x -O0 ../ej3/heuristicaGolosa.cpp -o ../ej3/heuristicaGolosa
rm ../ej3/heuristicaBusquedaLocal
g++ -std=c++0x -O0 ../ej3/heuristicaBusquedaLocal.cpp -o ../ej3/heuristicaBusquedaLocal
# rm ../ej3/busquedaTabu
